...
#define SK_BYTES   JADE_KEM_mlkem_kaiburr6_amd64_ref_SECRETKEYBYTES
#define PK_BYTES   JADE_KEM_mlkem_kaiburr6_amd64_ref_PUBLICKEYBYTES
#define CT_BYTES   JADE_KEM_mlkem_kaiburr6_amd64_ref_CIPHERTEXTBYTES
#define SS_BYTES   JADE_KEM_mlkem_kaiburr6_amd64_ref_BYTES
